...
$(function () {
            ...
            $.ajax({
                ...
                success: function (responseText) {
                    ...
                    if (responseText.message == "验证码错误") {
                        ...
                        window.location.th:href = path + "/index.html";
                    } else {
                    ...
                    $("#inputCaptcha").val("");
                    $("#captcha").attr("th:src", path + "/user/getGifCode.do?time=" + new Date().getTime());
    ...
    $("#captcha").click(function () {
        $(this).attr("th:src", path + "/user/getGifCode.do?time=" + new Date().getTime());
    });
});
/*----------------------表单验证以及提交表单----------------------end*/
