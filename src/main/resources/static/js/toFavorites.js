        ...
        success: function (responseText) {
            ...
            for (var index in responseText) {
                ...
                if (data.webSiteName == $condition) {
                    window.location.th:href = data.webSiteAddr;
                    $("#condition").val("");
                    return;
                }
            }
            ...
            success: function (responseText) {
                ...
                for (var index in responseText) {
                    ...
                    if (index.length > 16) {
                        ...
                        $("#manageSiteContent").before("<tr><td><input type='text' value=" + data.webSiteAddr + " /></td><td><input type='text' value=" + data.webSiteName + " /></td><td><a th:href=" + path + "/favorites/deleteSiteById.do?indexId=" + index + ">删除</a></td></tr>");
...
function createPage(totalPageCount) {
    for (var i = 1; i <= totalPageCount; i++) {
        $(".pagination").append("<li><a th:href='#' onclick='queryPage(" + i + ")'>" + i + "</a></li>");
    }
}
        ...
        success: function (responseText) {
            ...
            for (var index in responseText) {
                ...
                if (index.length > 16) {
                    ...
                    $("#manageSiteContent").before("<tr><td><input type='text' value=" + data.webSiteAddr + " /></td><td><input type='text' value=" + data.webSiteName + " /></td><td><a th:href='${request.contextPath}/favorites/deleteSiteById.do?indexId=" + index + "'>删除</a></td></tr>");
