...
(function($) {
	...
	$.fn.barrager = function(barrage) {
		...
		if(barrage.img){
			...
			div_barrager_box.append("<a class='portrait z' th:href='javascript:;'></a>");
			var img = $("<img th:src='' >").appendTo(id + " .barrage_box .portrait");
			img.attr('th:src', barrage.img);
		}
		...
		var content = $("<a title='' th:href='' target='_blank'></a>").appendTo(id + " .barrage_box .p");
		content.attr({
			'th:href': barrage.th:href,
			'id': barrage.id
