        ...
        success: function (responseText) {
            ...
            if (responseText == "" || responseText == null || responseText.length == 0) {
                ...
                for (var i = 0; i < responseText.length; i++) {
                    ...
                    $("#allMemo").append("<tr><td>" + responseText[i].nickName + "</td><td>" + new Date(responseText[i].editTime).toLocaleString() + "</td><td>" + responseText[i].email + "</td><td>" + responseText[i].content + "</td><td>" + new Date(responseText[i].sendTime).toLocaleString() + "</td><td>" + responseText[i].state + "</td><td><button class='btn btn-primary' onclick='updCurrentMemo(this)' id=" + memoId + "  data-toggle='modal' data-target='#myModal'>修改</button>&nbsp;&nbsp;<a th:href='" + path + "/memo/deleteMemo.do?memoId=" + memoId + "'>删除</a></td>");
